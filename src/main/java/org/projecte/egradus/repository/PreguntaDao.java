...
public interface PreguntaDao {
	...
	/**
	 * Agafa totes les preguntes en estat públic i les
	 * preguntes en estat editable que hagi creat el
	 * professor passat per paràmetre
	 * 
	 * @param codiProfessor
	 * @return
	 */
	...
	/**
	 * Agafa totes les preguntes associades a resposta-preguntes
	...
	/**
	 * Agafa les preguntes filtrades per els següents
	...
	/**
	 * Agafa la opcio identificada pel codi
	 ...
	 * 
	 * (Donam per suposat que la pregunta passada per
