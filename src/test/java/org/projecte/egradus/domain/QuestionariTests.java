...
public class QuestionariTests {
	...
	public void testQuestionariNumTotalActualitzacionsNotaMitjaMin() {
		...
		Set<ConstraintViolation<Questionari>> errors = validador.validateProperty(q,
				"numTotalActualitzacionsNotaMitja");
		assertEquals(1, errors.size());
	}
	...
	public void testGetNumPreguntesRecAmbUnaPreguntaRec() {
		// Inserim tres preguntes (una d'elles REC, per tant, NO es podrà corregir
		// automàticament)
		Pregunta preguntaEs1 = UtilTest.inserirPregunta(professor, "enunciat1", 0.43f, null, Boolean.TRUE, new Date(),
				Pregunta.TIPUS_ES1, null, Pregunta.ESTAT_PUBLIC);
		Pregunta preguntaRec = UtilTest.inserirPregunta(professor, "enunciat2", 0.88f, null, Boolean.FALSE, new Date(),
				Pregunta.TIPUS_REC, null, Pregunta.ESTAT_PUBLIC);
		Pregunta preguntaVof = UtilTest.inserirPregunta(professor, "enunciat3", 0.2f, null, Boolean.FALSE, new Date(),
				Pregunta.TIPUS_VOF, Boolean.FALSE, Pregunta.ESTAT_PUBLIC);
	...
	public void testGetNumPreguntesRecSenseCapPreguntaRec() {
		// Inserim tres preguntes (cap d'elles REC, per tant, es podrà corregir
		// automàticament)
		Pregunta preguntaEs1 = UtilTest.inserirPregunta(professor, "enunciat1", 0.43f, null, Boolean.TRUE, new Date(),
				Pregunta.TIPUS_ES1, null, Pregunta.ESTAT_PUBLIC);
		Pregunta preguntaEsN = UtilTest.inserirPregunta(professor, "enunciat2", 0.88f, null, Boolean.FALSE, new Date(),
				Pregunta.TIPUS_ESN, null, Pregunta.ESTAT_PUBLIC);
		Pregunta preguntaVof = UtilTest.inserirPregunta(professor, "enunciat3", 0.2f, null, Boolean.FALSE, new Date(),
				Pregunta.TIPUS_VOF, Boolean.TRUE, Pregunta.ESTAT_PUBLIC);
	...
	public void testActualitzaDificultatPracticaPrimeraContestacio() {
		...
		assertEquals(Float.valueOf(1f - QST_NOTA1 / 10), questionari.getDificultatPractica());
	}
	...
	public void testActualitzaDificultatPractica() {
		...
		assertEquals(Float.valueOf(((1f - QST_NOTA1 / 10) + (1f - QST_NOTA2 / 10)) / 2),
				questionari.getDificultatPractica());
	}
	...
	public void testActualitzaNotaMitja() {
		...
		assertEquals(Float.valueOf((QST_NOTA1 + QST_NOTA2) / 2), questionari.getNotaMitja());
	}
	...
	public void testActualitzaTempsRespostaMigPrimeraContestacio() throws ParseException {
		...
		assertEquals(Long.valueOf(tempsResposta), questionari.getTempsRespostaMig());
	}
	...
	public void testActualitzaTempsRespostaMig() throws ParseException {
		...
		assertEquals(Long.valueOf((tempsResposta1 + tempsResposta2) / 2), questionari.getTempsRespostaMig());
	}
