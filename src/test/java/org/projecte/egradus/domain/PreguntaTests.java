...
public class PreguntaTests {
	...
	public void testActualitzaDificultatPracticaPrimeraContestacio() {
		...
		assertEquals(new Float(1f - PRE_NOTA1/10), p.getDificultatPractica());
	}
	...
	public void testActualitzaDificultatPractica() {
		...
		assertEquals(new Float(((1f - PRE_NOTA1/10) + (1f - PRE_NOTA2/10)) / 2), p.getDificultatPractica());
	}
	...
	public void testActualitzaNotaMitja() {
		...
		assertEquals(new Float((PRE_NOTA1 + PRE_NOTA2) / 2), p.getNotaMitja());
	}
	...
	public void testActualitzaTempsRespostaMigPrimeraContestacio() throws ParseException {
		...
		assertEquals(new Long(tempsResposta), p.getTempsRespostaMig());
	}
	...
	public void testActualitzaTempsRespostaMig() throws ParseException {
		...
		assertEquals(new Long((tempsResposta1 + tempsResposta2) / 2), p.getTempsRespostaMig());
	}
