...
//	private static Boolean PRE_REC_VOF_VERTADER    = null;
	...
	public void initialize() {
		...
		// Inserim el rol d'alumne per a les 2 persones alumne 'personaAlumneX' a
	...
	public void testGetRespostesPregunta() {
		...
		alumnes.add(alumne1);
		List<RespostaPregunta> llistaRp = respostaPreguntaService.enviaPregunta(preguntaEs1.getCodi(), professor,
	...
	public void testGetRespostesQuestionariRec() {
		...
		// L'alumne 1 NO té cap qüestionari a les estadístiques, ja que el qüestionari
		// que
	...
	public void testGetRespostesQuestionariRecCorregit() {
		...
		// finalitzam la correcció del qüestionari (sense escrire cap text però
		// assignant una nota
	...
	public void testEstadistiquesProfessorByPregunta() {
		...
		// Obtenim les estadístiques de la preguntaEs1 i verificam cadascun dels seus
		// camps
		Map<String, Object> estadistiques = estadistiquesService
				.getEstadistiquesProfessorPreguntaAssignacioDirecta(preguntaEs1.getCodi(), assignatura.getCodi());
		...
		assertEquals(Float.valueOf(preguntaEs1.getTempsRespostaMig()),
				estadistiques.get(EstadistiquesService.PREGUNTA_TEMPS_RESPOSTA_MIG_ASS));
	}

	/**
	 * Enviam la pregunta a 2 alumnes i la contesten tots 2 però un d'ells no aprova
	 */
	@Test
	public void testEstadistiquesProfessorByPreguntaDosContesten() {
		...
		// definim un interval (ja que a cada execució del test, els temps poden canviar
		// i no ser exactament iguals)
		Float tempsRespostaEsperat = (Float) estadistiques.get(EstadistiquesService.PREGUNTA_TEMPS_RESPOSTA_MIG_ASS);
		Float tempsRespostaObtingut = Float.valueOf(preguntaEs1.getTempsRespostaMig());
...
//	}
	...
	private Pregunta novaPreguntaREC(Professor professor) {
		Pregunta pregunta = UtilTest.inserirPregunta(professor, PRE_REC_ENUNCIAT, PRE_REC_DIFICULTAT_TEO,
				PRE_REC_DIFICULTAT_PRA, PRE_REC_RAONAR_RESPOSTA, PRE_REC_DATA_ALTA, PRE_REC_TIPUS, null,
