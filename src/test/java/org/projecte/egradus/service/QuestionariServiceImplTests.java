...
//	private static Float   QST2_PES_PREG_REC    = 0.25f;
	...
	/**
	 * mètode privat que insereix un qüestionari amb una pregunta VOF i una REC, i
	 * un pès indicat explícitament per a la pregunta VOF, de manera que el pès de
	 * la pregunta REC es calcularà en proporció
	 */
	private void insereixQuestionari1() {
		...
		pesosQuestionari1.put(Integer.valueOf(preguntaVof.getCodi()), QST1_PES_PREG_VOF);
		pesosQuestionari1.put(Integer.valueOf(preguntaRec.getCodi()), null);
	...
	/**
	 * mètode privat que insereix un qüestionari amb una pregunta VOF i una REC
	 * sense indicar quin pès tendran dins ell (significant que cada pregunta valdrà
	...
	public void initialize() {
		personaProfessor = UtilTest.inserirPersona(PER1_NOM, PER1_PRIMER_LLINATGE, PER1_CORREU, PER1_ALIES, PER1_CLAU,
				UtilTest.getDate(PER1_DATA_ALTA));
		...
		// Quan inserim una assignatura, automàticament la persona s'insereix com a
		// professor
		...
		questionari1 = UtilTest.inserirQuestionari(professor, QST1_NOM, QST1_DESCRIPCIO, QST1_DIFICULTAT_TEO,
				QST1_DIFICULTAT_PRA, QST1_ESTAT, QST1_DATA_ALTA_REF);
		...
		questionari2 = UtilTest.inserirQuestionari(professor, QST2_NOM, QST2_DESCRIPCIO, QST2_DIFICULTAT_TEO,
				QST2_DIFICULTAT_PRA, QST2_ESTAT, QST2_DATA_ALTA_REF);

		// Cream una pregunta VOF
		preguntaVof = UtilTest.inserirPregunta(professor, PRE1_ENUNCIAT, PRE1_DIFICULTAT_TEO, PRE1_DIFICULTAT_PRA,
		...
		preguntaRec = UtilTest.inserirPregunta(professor, PRE2_ENUNCIAT, PRE2_DIFICULTAT_TEO, PRE2_DIFICULTAT_PRA,
				PRE2_RAONAR_RESPOSTA, PRE2_DATA_ALTA, PRE2_TIPUS, PRE1_VOF_VERTADER, Pregunta.ESTAT_PUBLIC);
	}
	...
	public void testInserirQuestionariAmbPreguntesIPes() {
		...
		pesos.put(Integer.valueOf(preguntaVof.getCodi()), QST1_PES_PREG_VOF);
		pesos.put(Integer.valueOf(preguntaRec.getCodi()), QST1_PES_PREG_REC);
	...
	public void testInserirQuestionariComprovacioPesosSensePasarliPesos() {
		...
		// inserim un qüestionari amb dues preguntes i sense indicar-li quins pesos
		// tendrà
		...
		assertEquals(Float.valueOf(1f / NUM_PREGUNTES), pes1);
		assertEquals(Float.valueOf(1f / NUM_PREGUNTES), pes2);
	}
	...
	public void testInserirQuestionariComprovacioPesosAmbLlistaPesosBuida() {
		...
		// inserim un qüestionari amb dues preguntes i passant-li una llista de pesos
		// buida
	...
	public void testInserirQuestionariComprovacioPesosLlistaPesosIncompleta() {
		...
		Map<Integer, Float> pesos = new HashMap<Integer, Float>();
		pesos.put(Integer.valueOf(preguntaVof.getCodi()), QST1_PES_PREG_VOF);
		pesos.put(Integer.valueOf(preguntaRec.getCodi()), null);
		...
		// en el qüestionari
		Float pesRec = Float.valueOf(1f - QST1_PES_PREG_VOF);
	...
	/**
	 * agafa tots els qüestionaris associats a resposta-questionaris que hagin sigut
	 * enviades per algún professor de l'assignatura
	 */
	@Test
	public void testGetQuestionarisByAssignatura() {
		insereixQuestionari1();

		// En aquest punt, la cerca de qüestionaris by assignatura no ens hauria de
		// retornar cap qüestionari
		...
		// En aquest punt, la cerca de qüestionaris by assignatura ens hauria de
		// retornar 1 qüestionari
		assertEquals(1, questionariService.getQuestionaris(assignatura).size());

		// Afegim un altre professor a l'assignatura: professor2
		personaProfessor2 = UtilTest.inserirPersona("nom", "llinatge1", "correu@correu.es", "alies", "clau",
				new Date());
		...
		// En aquest punt, la cerca de qüestionaris by assignatura ens hauria de
		// retornar, també, 1 qüestionari
		// (ja que ambdós professors han enviat el mateix qüestionari, i a
		// l'assignatura, per tant, només
		// hi ha participat un qüestionari).
		assertEquals(1, questionariService.getQuestionaris(assignatura).size());

		// Si un dels professors envia el qüestionari 2, la cerca de qüestionaris by
		// assignatura
	...
	public void testGetQuestionarisFiltreDataIniciOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(UtilTest.getDate(QST_DATA_INICI_OK),
				null, null, null, null, null, null, null, null, null, null, professor.getCodi().intValue());
	...
	public void testGetQuestionarisFiltreDataIniciNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(UtilTest.getDate(QST_DATA_INICI_NO),
				null, null, null, null, null, null, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDataFiOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null,
				UtilTest.getDate(QST_DATA_FI_OK), null, null, null, null, null, null, null, null, null,
				professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDataFiNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null,
				UtilTest.getDate(QST_DATA_FI_NO), null, null, null, null, null, null, null, null, null,
				professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreNomOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, QST_NOM_OK, null, null,
				null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreNomNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, QST_NOM_NO, null, null,
				null, null, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDescripcioOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, QST_DESCRIPCIO_OK,
				null, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDescripcioNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, QST_DESCRIPCIO_NO,
				null, null, null, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreCreadorNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null,
				QST_CREADOR_NO, null, null, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreCreadorAlies() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null,
				QST_CRE_ALIES_OK, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreCreadorNom() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null,
				QST_CRE_NOM_OK, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreCreadorLlinatge() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null,
				QST_CRE_LLINATGE_OK, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifTeo1Ok() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				QST_DIF_TEO1_OK, null, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifTeo1No() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				QST_DIF_TEO1_NO, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDifTeo2Ok() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, QST_DIF_TEO2_OK, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifTeo2No() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, QST_DIF_TEO2_NO, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDifTeoBetweenOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				QST_DIF_TEO1_OK, QST_DIF_TEO2_OK, null, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifTeoBetweenNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				QST_DIF_TEO1_NO, QST_DIF_TEO2_NO, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDifPra1Ok() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, QST_DIF_PRA1_OK, null, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifPra1No() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, QST_DIF_PRA1_NO, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDifPra2Ok() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, null, QST_DIF_PRA2_OK, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifPra2No() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, null, QST_DIF_PRA2_NO, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreDifPraBetweenOk() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, QST_DIF_PRA1_OK, QST_DIF_PRA2_OK, null, professor.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDifPraBetweenNo() {
		insereixQuestionari1();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, QST_DIF_PRA1_NO, QST_DIF_PRA2_NO, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreEstatPublic() {
		insereixQuestionari1();
		insereixQuestionari2();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null,
				Questionari.ESTAT_PUBLIC, null, null, null, null, null, professor.getCodi().intValue());
		assertNull(llistaQuestionaris);
	}
	...
	public void testGetQuestionarisFiltreEstatEditable() {
		...
		insereixQuestionari2();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null,
				Questionari.ESTAT_EDITABLE, null, null, null, null, null, professor.getCodi().intValue());
	...
	public void testGetQuestionarisFiltreEstatSenseIndicar() {
		...
		insereixQuestionari2();
		List<Questionari> llistaQuestionaris = questionariService.getQuestionaris(null, null, null, null, null, null,
				null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(2, llistaQuestionaris.size());
	}
	...
	public void testPublicaQuestionari() {
		...
		// comprovam que s'ha modificat correctament, però que segueix sent el mateix
		// qüestionari
	...
	public void testModificaQuestionariNom() {
		...
		Questionari questionari = UtilTest.inserirQuestionari(professor, nomDistint, QST1_DESCRIPCIO,
				QST1_DIFICULTAT_TEO, QST1_DIFICULTAT_PRA, QST1_ESTAT, QST1_DATA_ALTA_REF);

		// modificam el qüestionari original, amb les dades del nou qüestionari
		questionari1 = questionariService.modificaQuestionari(questionari1.getCodi(), questionari,
				new ArrayList<Pregunta>(), new HashMap<Integer, Float>());
	...
	public void testModificaQuestionariDescripcio() {
		...
		// Definim el nou qüestionari
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST1_NOM, descripcioDistinta,
				QST1_DIFICULTAT_TEO, QST1_DIFICULTAT_PRA, QST1_ESTAT, QST1_DATA_ALTA_REF);
	...
	public void testModificaQuestionariDificultatTeorica() {
		...
		// Comprovam que, abans de realitzar la modificació, la dificultat teòrica no
		// coincideix
		assertNotEquals(dificultatTeoricaDistinta, questionari1.getDificultatTeorica());

		// Definim el nou qüestionari
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST1_NOM, QST1_DESCRIPCIO,
				dificultatTeoricaDistinta, QST1_DIFICULTAT_PRA, QST1_ESTAT, QST1_DATA_ALTA_REF);
	...
	public void testModificaQuestionariPreguntesAbansSiDespresNo() {
		...
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST1_NOM, QST1_DESCRIPCIO, QST1_DIFICULTAT_TEO,
				QST1_DIFICULTAT_PRA, QST1_ESTAT, QST1_DATA_ALTA_REF);
	...
	public void testModificaQuestionariPreguntesAbansNoDespresSi() {
		...
		questionari1 = questionariService.modificaQuestionari(questionari1.getCodi(), questionari, llistaPreguntes,
				null);
	...
	public void testModificaQuestionariPreguntesDiferents() {
		...
		// Comprovam que la pregunta que té el qüestionari ja no és de tipus VOF, sino
		// de tipus REC
		assertEquals(1, questionari1.getPreguntes().size());
	...
	public void testModificaQuestionariPreguntesAmbDiferentsPesos() {
		insereixQuestionari1();
		// NOTA: el mètode privat 'insereixQuestionari1()' no assigna explícitament pès
		// per la segona
		// pregunta, però aquest és calculat dins el mètode de servei
		// insereixQuestionari()
		...
		assertEquals(QST1_PES_PREG_REC, questionari1.getPreguntes().get(1).getPes()); // podem comprovar que s'ha
																						// calculat bé, tot i no
																						// haver-lo indicat
																						// explícitament
		...
		// les preguntes preguntaVof i preguntaRec ja estan inserides a BD pel mètode
		// privat
		// insereixQuestionari1(), però les emmagatzemam a llistaPreguntes per a
		// afegir-les al
		// nou qüestionari
		List<Pregunta> llistaPreguntes = new ArrayList<Pregunta>();
		llistaPreguntes.add(preguntaVof);
		...
		Map<Integer, Float> pesos = new HashMap<Integer, Float>();
		pesos.put(Integer.valueOf(preguntaVof.getCodi()), null);
		pesos.put(Integer.valueOf(preguntaRec.getCodi()), QST1_PES_PREG_REC / 2f);

		// inserim el nou qüestionari (amb les mateixes preguntes que el qüestionari1
		// però amb un llistat de pesos distint)
		...
		// Comprovam que hi segueixen havent dues preguntes, però els pesos ja no són
		// els mateixos
		assertEquals(2, questionari1.getPreguntes().size());
		assertEquals(Float.valueOf(1f - QST1_PES_PREG_REC / 2f), questionari1.getPreguntes().get(0).getPes());
		assertEquals(Float.valueOf(QST1_PES_PREG_REC / 2f), questionari1.getPreguntes().get(1).getPes());
	}
