...
public class JPAQuestionariDaoTests {
	...
	public void testPersistQuestionari() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
	...
	public void testUpdateQuestionari() {
		...
		// comprobam que el nom del qüestionari ja és el nom distint, però els codis
		// coincideixen
	...
	public void testGetLlistaQuestionarisByAssignaturaVarios() {
		...
		Questionari questionari1 = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari1);

		Questionari questionari2 = UtilTest.inserirQuestionari(professor, QST2_NOM, QST2_DESCRIPCIO,
				QST2_DIFICULTAT_TEO, QST2_DIFICULTAT_PRA, QST2_ESTAT, UtilTest.getDate(QST2_DATA_ALTA_REF));
		...
		// Comprovam que, en l'àmbit de l'assignatura actual, hi han 2 qüestionaris (per
		// molt que,
	...
	public void testGetQuestionarisFiltreDataIniciOk() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(UtilTest.getDate(QST_DATA_INICI_OK),
	...
	public void testGetQuestionarisFiltreDataIniciNo() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(UtilTest.getDate(QST_DATA_INICI_NO),
				null, null, null, null, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(0, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDataFiOk() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null,
	...
	public void testGetQuestionarisFiltreNomOk() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, QST_NOM_OK, null, null,
	...
	public void testGetQuestionarisFiltreNomNo() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, QST_NOM_NO, null, null,
				null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(0, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreDescripcioOk() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, QST_DESCRIPCIO_OK,
	...
	public void testGetQuestionarisFiltreDescripcioNo() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, QST_DESCRIPCIO_NO,
				null, null, null, null, null, null, null, professor.getCodi().intValue());
		assertEquals(0, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreCreadorNo() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null,
	...
	public void testGetQuestionarisFiltreDifTeo1Ok() {
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, QST_ESTAT, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null, null, null,
	...
	public void testGetQuestionarisFiltreEstatPublic() {
		...
		Questionari questionari = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, Questionari.ESTAT_EDITABLE, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari);
		...
		Questionari questionari2 = UtilTest.inserirQuestionari(professor, QST_NOM, QST_DESCRIPCIO, QST_DIFICULTAT_TEO,
				QST_DIFICULTAT_PRA, Questionari.ESTAT_PUBLIC, UtilTest.getDate(QST_DATA_ALTA_REF));
		questionariDao.persistQuestionari(questionari2);

		// Consultam els qüestionaris en estat públic que veu el professor 1
		List<Questionari> llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null, null,
		...
		llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null, null,
				Questionari.ESTAT_PUBLIC, null, null, null, null, null, professor2.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreEstatEditable() {
		...
		llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null, null,
				Questionari.ESTAT_EDITABLE, null, null, null, null, null, professor2.getCodi().intValue());
		assertEquals(0, llistaQuestionaris.size());
	}
	...
	public void testGetQuestionarisFiltreEstatSenseIndicar() {
		...
		// Consultam els qüestionaris en estat editable que veu el professor 2
		llistaQuestionaris = questionariDao.getLlistaQuestionaris(null, null, null, null, null, null, null, null, null,
				null, null, professor2.getCodi().intValue());
		assertEquals(1, llistaQuestionaris.size());
	}
